namespace CleanArchitectureTemplate.Core.Constants;
public class StaticConfiguration
{
    public const long   CURRENT_USERID         = 1;
    public const int    MOBILE_LENGTH          = 15;
    public const int    NAME_LENGTH            = 56;
    public const int    EMAIL_LENGTH           = 128;
    public const int    PASSWORD_MAX_LENGTH    = 16;
    public const int    PASSWORD_MIN_LENGTH    = 8;
    public const int    COMMAN_LENGTH          = 512;
    public const int    PINCODE_LENGTH         = 6;
    public const int    MAX_LENGTH             = 5000;
    public const int    DECIMAL_PRECISION      = 35;
